...
export function TranscriptViewer({ segments, currentTime, onSegmentClick }: TranscriptViewerProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
      {/* Header */}
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="relative group">
            <button className="px-4 py-2 text-sm bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 flex items-center gap-2 shadow-sm transition-all">
              <Download className="w-4 h-4" />
              Export
            </button>
            <div className="absolute top-full right-0 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-all pointer-events-none group-hover:pointer-events-auto">
              <button
              ...
              <button
                ...
                className="block w-full text-left px-4 py-2.5 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors border-t border-gray-100 dark:border-gray-700"
              >
                Export as PDF
              </button>
            </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 text-sm rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm transition-all"
          />
        </div>
      </div>
            ...
            return (
              <div
                ...
                className={`group cursor-pointer p-4 rounded-xl transition-all duration-200 ${
                  isActive 
                    ? 'bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/20 shadow-md border-l-4 border-blue-500' 
                    : 'hover:bg-gray-50 dark:hover:bg-gray-700/50 hover:shadow-sm'
                }`}
              >
                <div className="flex items-start gap-3">
                  <span className="text-sm text-blue-600 dark:text-blue-400 font-mono whitespace-nowrap pt-0.5 bg-blue-50 dark:bg-blue-900/30 px-2 py-1 rounded">
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 transition-all p-2 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg"
                  >
                    {copiedId === segment.id ? (
