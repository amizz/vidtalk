/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 37e30114a71dbf9a057eeda2482db8e8)
...
declare namespace Cloudflare {
	interface Env {
		...
		AUTORAG_ID: string;
		DATABASE: DurableObjectNamespace<import("./workers/app").VidTalkDatabase>;
		VIDEO_PROCESSOR: DurableObjectNamespace<import("./workers/app").VideoProcessor>;
		CHAT_SESSION: DurableObjectNamespace<import("./workers/app").ChatSession>;
		VIDEO_CONVERTER: DurableObjectNamespace<import("./workers/app").VideoConverterContainer>;
		VIDEO_THUMBNAIL: DurableObjectNamespace<import("./workers/app").VideoThumbnailContainer>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_ACCOUNT_TOKEN" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_TOKEN" | "R2_PUBLIC_URL" | "AUTORAG_ID">> {}
}
